...
def render_migration_decision_inputs():
    ...
    with st.expander("⚙️ Operational Factors"):
        ...
        with col1:
            calculator.inputs["cloud_expertise_level"] = st.selectbox(
                "Team's Cloud Expertise Level",
                ["low", "medium", "high"],
                index=["low", "medium", "high"].index(calculator.inputs.get("cloud_expertise_level", "medium")),
            ...
            calculator.inputs["change_management_capability"] = st.selectbox(
                "Change Management Capability",
                ["low", "medium", "high"],
                index=["low", "medium", "high"].index(calculator.inputs.get("change_management_capability", "medium")),
        ...
        with col2:
            ...
            calculator.inputs["current_monitoring_quality"] = st.selectbox(
                "Current Monitoring Quality",
                ["poor", "medium", "excellent"],
                index=["poor", "medium", "excellent"].index(calculator.inputs.get("current_monitoring_quality", "medium")),
...
def enhanced_migration_decision_analysis(calculator_inputs, cloud_results):
    ...
    decision_inputs = {
        ...
        # Operational factors
        'cloud_expertise_level': calculator_inputs.get('cloud_expertise_level', 'medium'),
        ...
        'current_monitoring_quality': calculator_inputs.get('current_monitoring_quality', 'medium'),
        'change_management_capability': calculator_inputs.get('change_management_capability', 'medium'),
